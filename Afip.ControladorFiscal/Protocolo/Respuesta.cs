...
{
        /// <summary>
        /// Describe una respuesta del controlador fiscal.
        /// </summary>
        public class Respuesta
        {
                ...
                public Estado EstadoImpresora = new Estado();
                ...
                public string ExplicarEstadoImpresora()
                {
                        ...
                        switch (ModeloImpresora) {
                                case Afip.ControladorFiscal.Modelos.EpsonTiquedora:
                                case Afip.ControladorFiscal.Modelos.EpsonGenerico:
                                case Afip.ControladorFiscal.Modelos.Emulacion:
                                        if (Bit(EstadoImpresora.CodigoEstado, 14))
                                                Estado += "Bit 14: Sin papel;";
                                        break;
                                case Afip.ControladorFiscal.Modelos.HasarTiquedora:
                                case Afip.ControladorFiscal.Modelos.HasarGenerico:
                                        if (Bit(EstadoImpresora.CodigoEstado, 14))
