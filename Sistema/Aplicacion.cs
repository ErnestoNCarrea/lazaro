...
namespace Lazaro.WinMain
{
        public class Aplicacion
        {
                ...
                public static int Main(string[] args)
                {
                        ...
                        {
                                // Eliminar archivos viejos en la carpeta Components/*.dll (deberían estar en Components/Componente/*.dll)
                                try
                                {
                                        Lfx.Environment.Folders.DeleteWithWildcards(Lfx.Environment.Folders.ComponentsFolder, "*.dll");
                                        Lfx.Environment.Folders.DeleteWithWildcards(Lfx.Environment.Folders.ComponentsFolder, "*.pdb");
                                        Lfx.Environment.Folders.DeleteWithWildcards(Lfx.Environment.Folders.ComponentsFolder, "*.bak");
                                }
                                catch { }
                        }
                ...
                private static void IniciarSentry()
                {
                        try
                        {
                                var SentryDsn = Lfx.Workspace.Master.CurrentConfig.ReadGlobalSetting<string>("Sentry.DSN", null);
                                if (SentryDsn != null)
                                {
                                        SentrySdk.Init(o =>
                                        {
                                                                ...
                                                                if (Lfx.Workspace.Master.ConnectionParameters.ServerName.ToLowerInvariant() == "localhost")
                                                                {
                                                                        ...
                                                                        switch (Lfx.Data.DatabaseCache.DefaultCache.AccessMode)
                                                                        {
                                                                                case Lfx.Data.AccessModes.MySql:
                                                                                        TipoServidor = "MySQL";
                                                                                        break;
                                                                                case Lfx.Data.AccessModes.MariaDB:
