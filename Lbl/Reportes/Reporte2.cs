...
namespace Lbl.Reportes
{
        public class Reporte2
        {
                ...
                public Reporte2(Lfx.Data.IConnection connection, qGen.Select selectCommand)
                {
                ...
                public Lazaro.Pres.Spreadsheet.Sheet ToWorkbookSheet()
                {
                        ...
                        System.Data.DataTable Tabla = Connection.Select(Sel);
                        foreach (System.Data.DataRow Registro in Tabla.Rows) {
                                if (this.Grouping != null && Lfx.Types.Object.CompareByValue(this.Grouping.LastValue, Registro[Lazaro.Orm.Data.ColumnValue.GetNameOnly(this.Grouping.FieldName)]) != 0) {
                                        ...
                                        this.Grouping.LastValue = Registro[Lazaro.Orm.Data.ColumnValue.GetNameOnly(this.Grouping.FieldName)];

                                        // Agrego un encabezado
                                        if (ExpandGroups)
                                                Res.Rows.Add(new Lazaro.Pres.Spreadsheet.HeaderRow(Registro[Lazaro.Orm.Data.ColumnValue.GetNameOnly(this.Grouping.FieldName)].ToString()));
                                }
                                        ...
                                        foreach (Lfx.Data.Aggregate Agru in this.Aggregates) {
                                                switch (Agru.Function) {
                                                        case Lfx.Data.AggregationFunctions.Count:
                                                                ...
                                                                break;
                                                        case Lfx.Data.AggregationFunctions.Sum:
                                                                Agru.Sum += System.Convert.ToDecimal(Registro[Lazaro.Orm.Data.ColumnValue.GetNameOnly(Agru.FieldName)]);
                                                                break;
                                                }
                                        }
                                }
                                if (ExpandGroups) {
                                        ...
                                        foreach (Lazaro.Pres.Field Field in this.Fields) {
                                                Lazaro.Pres.Spreadsheet.Cell Celda = new Cell(Registro[Lazaro.Orm.Data.ColumnValue.GetNameOnly(Field.Name)]);
