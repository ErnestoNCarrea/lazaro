...
namespace Afip.Ws.LoginCms {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://wsaahomo.afip.gov.ar/ws/services/LoginCms", ConfigurationName="LoginCms.LoginCMS")]
    public interface LoginCMS {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Afip.Ws.LoginCms.LoginFault), Action="", Name="fault")]
        Afip.Ws.LoginCms.loginCmsResponse loginCms(Afip.Ws.LoginCms.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LoginCMSChannel : Afip.Ws.LoginCms.LoginCMS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<Afip.Ws.LoginCms.LoginCMS>, Afip.Ws.LoginCms.LoginCMS {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Afip.Ws.LoginCms.loginCmsResponse Afip.Ws.LoginCms.LoginCMS.loginCms(Afip.Ws.LoginCms.loginCmsRequest request) {
            return base.Channel.loginCms(request);
        }
        
        public string loginCms(string in0) {
            Afip.Ws.LoginCms.loginCmsRequest inValue = new Afip.Ws.LoginCms.loginCmsRequest();
            inValue.in0 = in0;
            Afip.Ws.LoginCms.loginCmsResponse retVal = ((Afip.Ws.LoginCms.LoginCMS)(this)).loginCms(inValue);
